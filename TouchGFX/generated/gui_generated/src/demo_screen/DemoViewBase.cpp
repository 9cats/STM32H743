    ...
    buttonCallback(this, &DemoViewBase::buttonCallbackHandler)
{
    ...
    Unicode::snprintf(hw_input_valueBuffer, HW_INPUT_VALUE_SIZE, "%s", touchgfx::TypedText(T___SINGLEUSE_9YCV).getText());
    hw_input_value.setWildcard(hw_input_valueBuffer);
    hw_input_value.setTypedText(touchgfx::TypedText(T___SINGLEUSE_VA5M));

    hw_input.setXY(360, 146);
    hw_input.setColor(touchgfx::Color::getColorFromRGB(0, 0, 0));
    hw_input.setLinespacing(0);
    hw_input.setTypedText(touchgfx::TypedText(T___SINGLEUSE_I7I2));
    ...
    hw_output.setLabelText(touchgfx::TypedText(T___SINGLEUSE_JX4Y));
