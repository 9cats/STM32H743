...
extern touchgfx::GeneratedFont& getFont_CASTELAR_TTF_16_4bpp();
extern touchgfx::GeneratedFont& getFont_FZSTK_TTF_10_4bpp();

const touchgfx::Font* touchgfx_fonts[] = {
    &(getFont_CASTELAR_TTF_16_4bpp()),
    &(getFont_FZSTK_TTF_10_4bpp())
};
...
void resetFont(touchgfx::FontId fontId)
{
    ...
    {
    case 0:
        touchgfx_fonts[0] = &(getFont_CASTELAR_TTF_16_4bpp());
        break;
    case 1:
        touchgfx_fonts[1] = &(getFont_FZSTK_TTF_10_4bpp());
        break;
    }
}
} // namespace TypedTextDatabase
